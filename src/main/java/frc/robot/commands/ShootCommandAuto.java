...
/** Spins up shooter then feeds game piece. Runs shooter at ~48 RPS (close range). Times out after 2 seconds. */
public class ShootCommandAuto extends SequentialCommandGroup {

    public ShootCommandAuto(Shooter shooter, Index index, Feeder feeder, Vision vision) {
        addCommands(
